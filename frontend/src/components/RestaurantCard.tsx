  ...
  return (
    ...
    >
      ...
      <div className="h-40 w-full overflow-hidden rounded-t-md">
        <img className="w-full h-full object-cover" src="https://i.pinimg.com/736x/63/c1/f3/63c1f38307b961d147e211e7ebacfdd0.jpg" alt="Sunset in the mountains"/>
      </div>
      ...
      <div className="p-4 flex-1 text-gray-800 text-sm">
        ...
        <div>
          <span className="text-xs mb-1">Contact:</span>{" "}
          {restaurant.contact}
        </div>
        <div>
